import ClassesModulesIdealsAssociativeAlgebrasCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  algebraConstrainedStatement := "algebra-constrained theorem certificate internalized through baseline gates, module-ideal-associative algebra structures, reviewer bridge, manifest hashes, and outside-constant dependency count",
